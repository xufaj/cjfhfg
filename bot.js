...
client.on("message", message => {
 ...
 if (message.content === "^^help") {
  ...
  const embed = new Discord.RichEmbed()
      ...
      .addField("『مصمم البوت : @SAJED   👻#8844  』", true)
...
-⚠ صيانه كل يوم
-💵 مجاني بل كامل 
-📚 البوت عربي و يمكن نضيف اللغة الانجليزية 
-📚 the bot is in arab maybe we will add the english language  
...
if (message.content === '^^support') {
      message.author.send(' |  تواصلو مع مصمم البوت @SAJED   👻#8844 | لـ أي استفسار').catch(e => console.log(e.stack));
...
if (message.content === '^^invite') {
      message.author.send(' رابط البوت |  https://discordapp.com/oauth2/authorize?client_id=523582693708136510&scope=bot&permissions=2146958591 ').catch(e => console.log(e.stack));
